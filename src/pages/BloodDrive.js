            ...
            <div className='popup-container popup-container-enter' id="cool-popup">
                <div className='popup nitesout-card red'>
                    ...
                    <form id='nitesout-waitlist' className='popup-inputs vert' onSubmit={saveAnswer}>
                        ...
                        <input ref={countryCode} className='inputForm' type='number' minLength={1} maxLength={3} placeholder='Country Code (+52)'/>
            ...
            <div className='popup-container popup-container-enter' id="cool-popup">
                <div className='popup nitesout-card red'>
                    ...
                    <form id='nitesout-waitlist' className='popup-inputs vert' onSubmit={saveAnswer}>
                        ...
                        <input ref={countryCode} className='inputForm' type='number' minLength={1} maxLength={4} placeholder='Su código de país (+52)'/>
                        <input ref={phNumber} className='inputForm' type='tel' /*pattern='[0-9]{2}-[0-9]{4}-[0-9]{4}'*/ required minLength="2" maxLength="30" placeholder='Su numero de telefono (33-3333-3333)'/>
